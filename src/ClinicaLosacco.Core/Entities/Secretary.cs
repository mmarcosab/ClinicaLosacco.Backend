...
namespace ClinicaLosacco.Core.Entities
{
    public class Secretary : Employee
    {
        ...
        public Secretary(string _name, string _email, string _phoneNumber, string _crm, List<string> _specialties, Address _address) : base(_name, _email, _phoneNumber, _address)
        {
